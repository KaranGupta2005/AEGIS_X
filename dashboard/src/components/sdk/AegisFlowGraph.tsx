    ...
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
        ...
        <div style={{ textAlign: 'left' }}>
          ...
          <div style={{ fontSize: 7, color: 'var(--text-muted)', fontFamily: 'JetBrains Mono' }}>
            {data.description}
          </div>
        </div>
      </div>
...
export const AegisFlowGraph: React.FC<AegisFlowGraphProps> = ({
  ...
  return (
    <div style={{ width: '100%', height: '100%', background: 'rgba(6,9,16,0.98)', borderRadius: 12, border: '1px solid var(--border-light)', overflow: 'hidden' }}>
      <ReactFlow
        nodes={nodes}
        edges={edges}
        nodeTypes={nodeTypes}
