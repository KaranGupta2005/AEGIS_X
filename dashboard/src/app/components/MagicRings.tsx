...
export default function MagicRings({
  color = '#10B981', colorTwo = '#06B6D4', speed = 1, ringCount = 6,
  attenuation = 10, lineThickness = 2, baseRadius = 0.35, radiusStep = 0.1,
  scaleRate = 0.1, opacity = 1, blur = 0, noiseAmount = 0.1, rotation = 0,
  ringGap = 1.5, fadeIn = 0.7, fadeOut = 0.5, followMouse = true,
  mouseInfluence = 0.2, hoverScale = 1.2, parallax = 0.05, clickBurst = true,
}: Props) {
  ...
  useEffect(() => {
    ...
    const uniforms: any = {
      ...
      uFadeIn: { value: 0.5 }, uFadeOut: { value: 0.75 },
  ...
  return <div ref={mountRef} style={{ width: '100%', height: '100%', filter: blur > 0 ? `blur(${blur}px)` : undefined }} />
}
